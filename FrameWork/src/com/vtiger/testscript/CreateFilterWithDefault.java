...
public class CreateFilterWithDefault extends BaseClass {
	@Test
	public void create() throws IOException, Throwable
	{
		...
		Actions act = new Actions(driver);
				...
				driver.findElement(By.className("detailedViewTextBox")).sendKeys(d.fetchDataFromExcel("Sheet1", 6,5 ));
				cf.getSetAsDefaultChkBox().click();
